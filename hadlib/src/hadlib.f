...
C----------- AUTHORS: AVERSA-CHIAPPETTA-GRECO-GUILLET
C----------- MAINTAINED BY J.Ph.GUILLET (guillet@lapp.in2p3.fr)
C----------- COMBINATION OF STRUCTURE FUNCTIONS ARE IN stru.f
C
C---CARREE DES ELEMENTS DE MATRICE (INTEGRATED ON  PHASE SPACE)--
